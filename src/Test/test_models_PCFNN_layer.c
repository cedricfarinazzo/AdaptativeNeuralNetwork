...
{
    struct PCFNN_LAYER *l = PCFNN_LAYER_new(NULL, NULL);
...
{
    struct PCFNN_LAYER *l1 = PCFNN_LAYER_new_input(10, f_act_input);
    struct PCFNN_LAYER *l2 = PCFNN_LAYER_new(NULL, NULL);
    
    cr_expect_eq(PCFNN_LAYER_connect(l1, l2, 10, 25, 0, 0, f_init_rand_norm, f_act_sigmoid), 0);
...
Test(PCFNN_LAYER, Builder)
{
    ...
    cr_expect_eq(PCFNN_LAYER_connect(l1, l2, 2, 2, 0, 0, f_init_rand_norm, f_act_sigmoid), 0);
    cr_expect_eq(PCFNN_LAYER_connect(l2, l3, 2, 1, 0, 0, f_init_rand_norm, f_act_sigmoid), 0);
...
Test(PCFNN_LAYER, Builder2)
{
    ...
    cr_expect_eq(PCFNN_LAYER_connect(l1, l2, 2, 2, 0, 0, f_init_rand_norm, f_act_sigmoid), 0);
    cr_expect_eq(PCFNN_LAYER_connect(l1, l3, 2, 2, 0, 0, f_init_rand_norm, f_act_sigmoid), 0);
    
    cr_expect_eq(PCFNN_LAYER_connect(l2, l4, 2, 2, 0, 0, f_init_rand_norm, f_act_sigmoid), 0);
    cr_expect_eq(PCFNN_LAYER_connect(l3, l4, 2, 1, 0, 2, f_init_rand_norm, f_act_sigmoid), 0);
